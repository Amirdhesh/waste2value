...
const CustomerPayment = ({navigation}) => {
  const cartdata = [
    ...
    const Product=({item})=>(
      <View style={{paddingVertical:12,borderBottomWidth:1,flexDirection:'row',justifyContent:'space-between',alignItems:'center', borderColor:'black'}}>
      <View style={{flexDirection:'row',alignItems:'center'}}>
          <View style={{height:70,width:70,backgroundColor:"#D9D9D9",borderRadius:10}}>
     ...
     <FontAwesome name="remove" size={24} color="black" style={{marginRight:10}}/>
     </View>
    )
  return (
    <View style={{flex:1}}>
      ...
      <View style={{height:'40%',flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
        <View style={{height:"85%",flexDirection:'column',alignItems:'center',width:'97%',elevation:5,backgroundColor:'#F5F5F5',borderRadius:10,borderWidth:2,borderColor:'#C96FC4'}}>
          <FlatList
          data={cartdata}
